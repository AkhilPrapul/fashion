<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPage.master" AutoEventWireup="true"
    CodeFile="AddItem.aspx.cs" Inherits="Admin_AddItem" %>
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="table table-responsive">
                ...
                <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:CBFashionCon %>"
                    DeleteCommand="DELETE FROM [ItemMst] WHERE [IID] = @IID" InsertCommand="INSERT INTO [ItemMst] ([IName], [Detail], [Price], [Image], [Qnt], [CName], [Image1], [Image2], [Size]) VALUES (@IName, @Detail, @Price, @Image, @Qnt, @CName, @Image1, @Image2, @Size)"
